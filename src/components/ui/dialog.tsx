...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { showOverlay?: boolean, showCloseButton?: boolean }
>(({ className, children, showOverlay = true, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
